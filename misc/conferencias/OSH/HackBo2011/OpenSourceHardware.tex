...
\institute[\url{altaimpedancia.org}]
{ \inst{1}
...
\date[HackBo 02/11/11]
{HackBo 2 de Noviembre de 2011}
...
\begin{frame}{Open Source Hardware}
  ...
  \item Para abrir la capa de infraestructura se deben tener en cuanta:
    \begin{itemize}
    \item Free Hardware Design (Antes).
    \item Open Source Hardware (Ahora)
    \item Copyleft Hardware (Ahora)
    \end{itemize}
  \item El modelo del software libre se puede extender hasta Free Hardware Design (Antes).
%  \item Debe usarse otro modelo para la implementación de Open Source Hardware.
  \item Cualquiera de los dos últimos modelos encamina este objetivo.
...
\begin{frame}{Conclusiones}
  \begin{block}{}
    ...
    \item Hay un grave problema de interoperabilidad entre formatos y herramientas (Antes).
    \end{itemize}
  \end{block}
\end{frame}
...
\begin{frame}[allowframebreaks]
  ...
  \bibitem<1->[10]{copylefthardware}\emph{Qi-Hardware}, \url{http://qi-hardware.com}
  \bibitem<1->[11]{OSHW}\emph{Open Source Hardware (OSHW) Statement of Principles and Definition v1.0}, \url{http://freedomdefined.org/OSHW}
