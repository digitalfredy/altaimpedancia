...
% \includexmp{metadata}
\usepackage{hyperref}
\hypersetup{pdfkeywords=open free design source hardware colombia Software Libre abierto SLUD8 SLUD SLUDVIII VIII 8 GLUD Grupo Linux Universidad Distrital 2009 AltaImpedancia alta impedancia electrónica}
...
\date[SLUD VIII 2009]
{Semana Linux Universidad Distrital VIII\\3 de diciembre de 2009}
